...
// Save provides a mock function with given fields: exercise
func (_m *ExerciseRepository) Save(exercise crossfit.Exercise) error {
	ret := _m.Called(exercise)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(crossfit.Exercise) error); ok {
		r0 = rf(exercise)
	} else {
		r0 = ret.Error(0)
	}
